...
CREATE TRIGGER IF NOT EXISTS update_last_changed BEFORE UPDATE ON PROBAND FOR EACH ROW SET NEW.lastChanged = CURRENT_TIMESTAMP;
...
ALTER TABLE
    ...
    -- ADD CONSTRAINT `patientsickness_sicknessid_fk_2`
        ADD FOREIGN KEY (`sicknessId`) REFERENCES `DISEASES`(`id`);
